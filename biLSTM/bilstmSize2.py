...
def main():
    ...
    # Checkpoint
    checkpoint_path = "../models/biLSTM/normalCase/checkpoint"
    ...
    # Save model
    model.save(f'../models/biLSTM/normalCase/bilstmSize{WINDOW_SIZE}.h5')

    # Save Tokenizer i.e. Vocabulary
    with open(f'../models/biLSTM/normalCase/tokenizerBilstmSize{WINDOW_SIZE}.pickle', 'wb') as handle:
    ...
    with open(f'../models/biLSTM/normalCase/f1ScoreMulticlassBilstmHansardSize{WINDOW_SIZE}.txt', 'w') as f:
