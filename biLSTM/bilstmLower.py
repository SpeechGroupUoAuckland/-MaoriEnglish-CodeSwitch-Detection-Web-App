...
def main():
    ...
    # Save model
    model.save('../models/biLSTM/lowerCase/bilstm.h5')

    # Save Tokenizer i.e. Vocabulary
    with open('../models/biLSTM/lowerCase/tokenizerBilstm.pickle', 'wb') as handle:
    ...
    with open('../models/biLSTM/lowerCase/f1ScoreMulticlassBilstmHansard.txt', 'w') as f:
