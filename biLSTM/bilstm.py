...
def main():
    ...
    df = pd.read_csv('../20220321_Hansard_DB_MP_only.csv')
    ...
    # Save model
    model.save('../models/biLSTM/normalCase/bilstm.h5')

    # Save Tokenizer i.e. Vocabulary
    with open('../models/biLSTM/normalCase/tokenizerBilstm.pickle', 'wb') as handle:
    ...
    with open('../models/biLSTM/normalCase/f1ScoreMulticlassBilstmHansard.txt', 'w') as f:
